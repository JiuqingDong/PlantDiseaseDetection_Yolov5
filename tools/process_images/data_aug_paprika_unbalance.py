...
if __name__ == "__main__":
    ...
    set = 'val'
    org_datasets = 'paprika_v4'
    aug_datasets = 'paprika_v8_aug'

    IMG_DIR = "/Volumes/Data/project_paper_code_data/yolov5-official_new/datasets/" + org_datasets + "/images/"+set
    XML_DIR = "/Volumes/Data/project_paper_code_data/yolov5-official_new/datasets/" + org_datasets + "/labels/"+set+"_xml"
    print(XML_DIR)
    print(IMG_DIR)
    # 存储增强后的XML文件夹路径
