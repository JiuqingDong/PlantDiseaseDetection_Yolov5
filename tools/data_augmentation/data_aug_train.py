...
if __name__ == "__main__":
    # 原始的img与xml文件路径
    set='train'
    IMG_DIR = "/Users/Dong/Desktop/test/dataset_org/"+set
    XML_DIR = "/Users/Dong/Desktop/test/dataset_org/"+set+"_xml"
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = "/Users/Dong/Desktop/test/dataset_aug/"+set+"_xml"
    try:
