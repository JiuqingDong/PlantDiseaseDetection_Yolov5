...
if __name__ == "__main__":
    # 原始的img与xml文件路径
    set='val'
    IMG_DIR = "/Users/Dong/Documents/test/dataset_org/"+set
    XML_DIR = "/Users/Dong/Documents/test/dataset_org/"+set+"_xml"
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = "/Users/Dong/Documents/test/dataset_aug/"+set+"_xml"
    try:
    ...
    mkdir(AUG_XML_DIR)
    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = "/Users/Dong/Documents/test/dataset_aug/"+set
    try:
